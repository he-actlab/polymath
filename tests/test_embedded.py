...
#
#
#     x_shape = (n_, ic_, ih_, iw_)
#     kernel_shape = (f_, ic_, kh_, kw_)
#     x_ = np.random.randint(1, 5, x_shape)
#     w_ = np.random.randint(1, 5, kernel_shape)
#     b_ = np.random.randint(1, 5, (f_))
#     params = {"stride": stride_, "pad": pad_}
#
#     test_out = conv3d(x_, w_, b_, params)
#     mapping = {"ih": ih_,
#                "iw": iw_,
#                "ic": ic_,
#                "n": n_,
...
#         ih = pm.placeholder("ih")
#         iw = pm.placeholder("iw")
#         ic = pm.placeholder("ic")
#         n = pm.placeholder("n")
#         kw = pm.placeholder("kw")
#         kh = pm.placeholder("kh")
#         stride = pm.placeholder("stride")
#         pad = pm.placeholder("pad")
#         f = pm.placeholder("f")
#         oh = pm.placeholder("oh")
#         ow = pm.placeholder("ow")
#         x = pm.placeholder("x", shape=(n,ic,ih,iw))
#         w = pm.placeholder("w", shape=(f,ic,kh, kw))
#         b = pm.placeholder("b", shape=(f))
#         i = pm.index(0, m - 1, name="i")
#         j = pm.index(0, n - 1, name="j")
#         k = pm.index(0, p - 1, name="k")
#         padded_inp1 = pm.variable(0, name="padded_inp1", shape=(n, ic, ih+2*pad, iw+2*pad))
#         padded_inp = pm.var_index(padded_inp1, )
#
#
...
#         out = pm.sum([i, k, j], slice_mul, name="out")
        # out = pm.sum([k], slice_mul, name="out")
    # graph_res = graph("out", mapping)
    # print(f"Numpy res: {numpy_res}\n\n")
    # print(f"graph res: {graph_res}")
...
def test_parametrized_decorator():
    with pm.Node() as graph:
        a, b = _split_in_two(pm.variable('abcd', name="testing"))
...
#         a = pm.placeholder()
#         b = pm.placeholder()
#         c = pm.cache(_cached_add(a, b), cache.__getitem__, cache.setdefault)
#
#     for _ in range(3):
...
#             a = pm.placeholder()
#             b = pm.placeholder()
#             c = pm.cache_file(a + b, f"{tmpdir}/%s.pkl")
#
