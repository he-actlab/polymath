...
import os
from typing import List, Tuple, Text, Set
...
class Extractor:
    ...
    def _dfs_search_reachable_nodes(
        ...
        if node_output_name in graph_input_names:
            return []
        elif node_output_name in self.reachable_nodes:
            return []
        reachable_nodes = []
        for node in self.graph.node:
            ...
            for name in node.input:
                reachable_nodes += self._dfs_search_reachable_nodes(name, graph_input_names)
        self.reachable_nodes[node_output_name] = tuple(reachable_nodes)
    ...
    def _collect_reachable_nodes(
        ...
        for name in output_names:
            reachable_nodes += self._dfs_search_reachable_nodes(name, input_names)
