...
from polymath.codegen.dnnweavergen.dnnweaver2.utils.utils import ceil_a_by_b, log2
from polymath.codegen.dnnweavergen.dnnweaver2.simulator.loop_stack import LoopStack
from polymath.codegen.dnnweavergen.dnnweaver2.simulator.stats import Stats
...
def get_stats_fast(conv_params, tiling, order_type, verbose=False):
    ...
    if verbose:
        logger.debug('Initialize reads/def_use')
