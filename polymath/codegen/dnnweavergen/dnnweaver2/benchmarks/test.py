from codegen.dnnweavergen.dnnweaver2.graph import Graph, get_default_graph

from codegen.dnnweavergen.dnnweaver2.tensorOps.cnn import conv2D, maxPool, flatten, matmul, addBias, batch_norm, reorg, concat, leakyReLU
from codegen.dnnweavergen.dnnweaver2 import get_tensor
import logging
from codegen.dnnweavergen.dnnweaver2.scalar.dtypes import FQDtype, FixedPoint
...
def yolo_convolution(tensor_in, filters=32, kernel_size=3,
    ...
    if act == 'leakyReLU':
        ...
        logging.error('Unknown activation type {}'.format(act))
