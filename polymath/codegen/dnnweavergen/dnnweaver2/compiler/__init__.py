from polymath.codegen.dnnweavergen.dnnweaver2.tensorOps.cnn import *
from polymath.codegen.dnnweavergen.dnnweaver2.graph import Graph
from polymath.codegen.dnnweavergen.dnnweaver2.tensor import Tensor

from polymath.codegen.dnnweavergen.dnnweaver2.optimizer.optimizer import optimize_for_order, get_stats_fast
from polymath.codegen.dnnweavergen.dnnweaver2.isa import *
from polymath.codegen.dnnweavergen.dnnweaver2.isa import ScratchPad, AccessType
...
from polymath.codegen.dnnweavergen.dnnweaver2.compiler.pu_compiler import PUCompiler
...
class GraphCompiler(object):
    ...
    def compile(self, graph, acc_obj):
        ...
        self.log.debug('#'*50)
        self.log.debug('Combining graph_name ops to create macro op')
        macro_node_array = []
        curr_node = None
        ...
        assert curr_node is not None
        macro_node_array.append(curr_node)
        self.log.debug('Combining graph_name ops to create macro op - done!')
